...
export const countryCodes: Country[] = [
  ...
  { name: "Holy See (Vatican City)", code: "VA", dialCode: "+379", flag: "🇻🇦" },
  ...
  { name: "Korea, Republic of South Korea", code: "KR", dialCode: "+82", flag: "🇰🇷" },
...
// Default to Ethiopia since that's where your app is focused
export const defaultCountry = countryCodes.find(country => country.code === 'ET') || countryCodes[0]
