...
export default function MarketplaceHeader({
  ...
  return (
    <div className="mb-8 space-y-5">
      {/* Hero banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-accent-500 via-accent-400 to-accent-600 p-6 md:p-8 shadow-xl">
      ...
      <div className="flex flex-col md:flex-row gap-3">
        ...
        <div className="flex items-center gap-2 bg-primary-900/70 backdrop-blur border border-accent-500/30 rounded-2xl px-3 shadow-lg shadow-black/30">
